    ...
    <div className="mb-16 text-left">
      ...
      <Accordion type="single" collapsible className="w-full">
        ...
        <AccordionItem value="item-2" className="border-b border-nature-border">
          <AccordionTrigger className="hover:no-underline font-medium py-4">Hoe wordt “Aanbevolen” bepaald?</AccordionTrigger>
          <AccordionContent className="text-left text-nature-text text-opacity-80 leading-relaxed">
            Aanbevolen kijkt vooral naar hoeveel eiwit je krijgt voor je geld. We nemen ook de korting of actie mee, hoeveel eiwit er per 100 gram in zit, en hoe goed de eiwitten passen bij het aantal calorieën. Zo komt niet alleen de grootste korting bovenaan, maar vooral de aanbieding die waarschijnlijk de beste waarde heeft.
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-6" className="border-b border-nature-border">
